            ...
            <Card className="card-hover">
              ...
              <CardContent>
                <div className="text-2xl font-bold text-green-600">
                  {loading ? '...' : stats.successfulRanks.toLocaleString()}
                </div>
                <p className="text-xs text-muted-foreground">
                  {stats.trends.successfulRanks > 0 ? 
            ...
            <Card className="card-hover">
              ...
              <CardContent>
                <div className="text-2xl font-bold text-red-600">
                  {loading ? '...' : stats.invalidRequests}
                </div>
                <p className="text-xs text-muted-foreground">
                  {stats.trends.invalidRequests > 0 ? 
          ...
          >
            <Card className="card-hover">
              ...
              <CardContent>
                ...
                <p className="text-xs text-muted-foreground">
                  Today: {loading ? '...' : stats.todayRequests} requests
                </p>
              </CardContent>
            </Card>
          </motion.div>
...
Today's Requests: ${stats.todayRequests}
                    ...
                    <CardContent>
                      <div className="space-y-2">
                        <div className="flex justify-between text-sm">
                          <span>Today</span>
                          <span className="font-medium">{loading ? '...' : stats.todayRequests} requests</span>
                        </div>
                        <div className="flex justify-between text-sm">
                          <span>Total</span>
                          <span className="font-medium">{loading ? '...' : stats.totalRequests} requests</span>
                        </div>
                      </div>
                    </CardContent>
                  </Card>
