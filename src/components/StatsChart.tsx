...
export default function StatsChart({ data }: StatsChartProps) {
  ...
  // Pie chart data
  const pieData = [
    { name: 'Successful', value: data.successfulRanks, color: '#10b981' },
    { name: 'Invalid', value: data.invalidRequests, color: '#f59e0b' },
    { name: 'Failed', value: data.failedRequests, color: '#ef4444' }
  ];
